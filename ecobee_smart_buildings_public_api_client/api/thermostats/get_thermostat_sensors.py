...
from ...models.thermostat_sensors import ThermostatSensors
...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/api/v1/thermostats/{thermostatId}/sensors".format(client.base_url, thermostatId=thermostat_id)
...
) -> Optional[Union[BaseErrorResponse, BaseFailResponse, ThermostatSensors]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = ThermostatSensors.from_dict(response.json())
...
def _build_response(
    *, client: Client, response: httpx.Response
) -> Response[Union[BaseErrorResponse, BaseFailResponse, ThermostatSensors]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get current status of all sensors connected to a thermostat
     ...
     Returns a list with sensor data for all sensors on a thermostat
