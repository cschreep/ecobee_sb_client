...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/api/v1/thermostats/{thermostatId}/heatHold".format(client.base_url, thermostatId=thermostat_id)
...
def sync_detailed(
    ...
    *,
    ...
    """Set a heat hold on the thermostat
     ...
     Create a heat hold on a thermostat based on a provided desired temperature. Used when thermostat
    HVAC mode is set to \"heat\", \"auxHeatOnly\", or \"auto\".
