...
from ...models.update_base_thermostat_request_body import UpdateBaseThermostatRequestBody
...
def _get_kwargs(
    ...
    *,
    ...
    json_body: UpdateBaseThermostatRequestBody,
) -> Dict[str, Any]:
    url = "{}/api/v1/thermostats/{thermostatId}".format(client.base_url, thermostatId=thermostat_id)
...
) -> Optional[Union[BaseErrorResponse, BaseFailResponse]]:
...
def _build_response(
    *, client: Client, response: httpx.Response
) -> Response[Union[BaseErrorResponse, BaseFailResponse]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Update base thermostat information
     ...
     Updates base thermostat information
