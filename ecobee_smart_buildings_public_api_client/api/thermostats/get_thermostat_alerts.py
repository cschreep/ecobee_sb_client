...
from ...models.thermostat_alerts import ThermostatAlerts
...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/api/v1/thermostats/{thermostatId}/alerts".format(client.base_url, thermostatId=thermostat_id)
...
) -> Optional[Union[BaseErrorResponse, BaseFailResponse, ThermostatAlerts]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = ThermostatAlerts.from_dict(response.json())
...
def _build_response(
    *, client: Client, response: httpx.Response
) -> Response[Union[BaseErrorResponse, BaseFailResponse, ThermostatAlerts]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get current alerts on a thermostat
     ...
     Returns a list of all unacknowledged alerts on a thermostat
