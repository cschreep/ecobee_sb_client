...
from ...models.tenant_mode_request_body import TenantModeRequestBody
...
def _get_kwargs(
    ...
    *,
    ...
    json_body: TenantModeRequestBody,
) -> Dict[str, Any]:
    url = "{}/api/v1/thermostats/{thermostatId}/tenantMode".format(client.base_url, thermostatId=thermostat_id)
...
) -> Optional[Union[Any, BaseErrorResponse, BaseFailResponse]]:
...
def _build_response(
    *, client: Client, response: httpx.Response
) -> Response[Union[Any, BaseErrorResponse, BaseFailResponse]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Set or unset tenant mode on a thermostat
     ...
     Will turn tenant mode on or off on a thermostat.  For more information about tenant mode, please see
    https://docs.sb.ecobee.com/docs/tenant-mode
