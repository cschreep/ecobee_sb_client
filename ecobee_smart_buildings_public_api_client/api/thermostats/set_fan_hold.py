...
from ...models.fan_hold_request_body import FanHoldRequestBody
from ...models.fan_hold_response import FanHoldResponse
...
def _get_kwargs(
    ...
    *,
    ...
    json_body: FanHoldRequestBody,
) -> Dict[str, Any]:
    url = "{}/api/v1/thermostats/{thermostatId}/fanHold".format(client.base_url, thermostatId=thermostat_id)
...
) -> Optional[Union[BaseErrorResponse, BaseFailResponse, FanHoldResponse]]:
    if response.status_code == HTTPStatus.CREATED:
        response_201 = FanHoldResponse.from_dict(response.json())
...
def _build_response(
    *, client: Client, response: httpx.Response
) -> Response[Union[BaseErrorResponse, BaseFailResponse, FanHoldResponse]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Set a fan hold on the thermostat
     ...
     Creates a fan-only hold on the thermostat
