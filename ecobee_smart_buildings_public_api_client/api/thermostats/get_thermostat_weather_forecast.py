...
from ...models.thermostat_weather_forecast import ThermostatWeatherForecast
...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/api/v1/thermostats/{thermostatId}/weather".format(client.base_url, thermostatId=thermostat_id)
...
) -> Optional[Union[BaseErrorResponse, BaseFailResponse, ThermostatWeatherForecast]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = ThermostatWeatherForecast.from_dict(response.json())
...
def _build_response(
    *, client: Client, response: httpx.Response
) -> Response[Union[BaseErrorResponse, BaseFailResponse, ThermostatWeatherForecast]]:
    return Response(
