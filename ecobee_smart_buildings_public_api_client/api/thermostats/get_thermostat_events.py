...
from ...models.thermostat_events import ThermostatEvents
...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/api/v1/thermostats/{thermostatId}/events".format(client.base_url, thermostatId=thermostat_id)
...
) -> Optional[Union[BaseErrorResponse, BaseFailResponse, ThermostatEvents]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = ThermostatEvents.from_dict(response.json())
...
def _build_response(
    *, client: Client, response: httpx.Response
) -> Response[Union[BaseErrorResponse, BaseFailResponse, ThermostatEvents]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get current events on a thermostat
     ...
     Returns the current event on the thermostat and any other future holds
