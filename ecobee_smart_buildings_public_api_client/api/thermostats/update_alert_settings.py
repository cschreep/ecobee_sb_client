...
from ...models.alert_settings_request_body import AlertSettingsRequestBody
from ...models.alert_settings_response import AlertSettingsResponse
...
def _get_kwargs(
    ...
    *,
    ...
    json_body: AlertSettingsRequestBody,
) -> Dict[str, Any]:
    url = "{}/api/v1/thermostats/{thermostatId}/alertSettings".format(client.base_url, thermostatId=thermostat_id)
...
) -> Optional[Union[AlertSettingsResponse, BaseErrorResponse, BaseFailResponse]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = AlertSettingsResponse.from_dict(response.json())
...
def _build_response(
    *, client: Client, response: httpx.Response
) -> Response[Union[AlertSettingsResponse, BaseErrorResponse, BaseFailResponse]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Update alert and reminder settings on thermostat
     ...
     Updates alert and reminder settings on the thermostat.
