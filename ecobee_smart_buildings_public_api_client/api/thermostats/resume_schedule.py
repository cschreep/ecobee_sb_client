...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/api/v1/thermostats/{thermostatId}/resumeSchedule".format(client.base_url, thermostatId=thermostat_id)
...
def sync_detailed(
    ...
    *,
    ...
    """Resume the thermostat schedule.
     ...
     Cancels any manual holds on a thermostat and resumes the regular schedule.
