...
if TYPE_CHECKING:
    from ..models.alert_settings_response_data_ac_maintenance_reminder import (
        AlertSettingsResponseDataAcMaintenanceReminder,
    )
    from ..models.alert_settings_response_data_hvac_maintenance_reminder import (
        AlertSettingsResponseDataHvacMaintenanceReminder,
    )
    from ..models.high_humidity_alert_schema import HighHumidityAlertSchema
    from ..models.low_humidity_alert_schema import LowHumidityAlertSchema
    from ..models.temperature_alert_schema import TemperatureAlertSchema


T = TypeVar("T", bound="AlertSettingsResponseData")


@attr.s(auto_attribs=True)
class AlertSettingsResponseData:
    """
    Attributes:
        id (Union[Unset, str]): The unique identifier for a thermostat. The ID will match the serial number on the
            physical thermostat.
        low_temperature_alert (Union[Unset, TemperatureAlertSchema]):
        high_temperature_alert (Union[Unset, TemperatureAlertSchema]):
        low_humidity_alert (Union[Unset, LowHumidityAlertSchema]):
        high_humidity_alert (Union[Unset, HighHumidityAlertSchema]):
        ac_maintenance_reminder (Union[Unset, AlertSettingsResponseDataAcMaintenanceReminder]):
        hvac_maintenance_reminder (Union[Unset, AlertSettingsResponseDataHvacMaintenanceReminder]):
    """

    id: Union[Unset, str] = UNSET
    low_temperature_alert: Union[Unset, "TemperatureAlertSchema"] = UNSET
    high_temperature_alert: Union[Unset, "TemperatureAlertSchema"] = UNSET
    low_humidity_alert: Union[Unset, "LowHumidityAlertSchema"] = UNSET
    high_humidity_alert: Union[Unset, "HighHumidityAlertSchema"] = UNSET
    ac_maintenance_reminder: Union[Unset, "AlertSettingsResponseDataAcMaintenanceReminder"] = UNSET
    hvac_maintenance_reminder: Union[Unset, "AlertSettingsResponseDataHvacMaintenanceReminder"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_low_temperature_alert, Unset):
            ...
            low_temperature_alert = TemperatureAlertSchema.from_dict(_low_temperature_alert)
        ...
        if isinstance(_high_temperature_alert, Unset):
            ...
            high_temperature_alert = TemperatureAlertSchema.from_dict(_high_temperature_alert)
        ...
        if isinstance(_low_humidity_alert, Unset):
            ...
            low_humidity_alert = LowHumidityAlertSchema.from_dict(_low_humidity_alert)
        ...
        if isinstance(_high_humidity_alert, Unset):
            ...
            high_humidity_alert = HighHumidityAlertSchema.from_dict(_high_humidity_alert)
        ...
        if isinstance(_ac_maintenance_reminder, Unset):
            ...
            ac_maintenance_reminder = AlertSettingsResponseDataAcMaintenanceReminder.from_dict(_ac_maintenance_reminder)
        ...
        if isinstance(_hvac_maintenance_reminder, Unset):
            ...
            hvac_maintenance_reminder = AlertSettingsResponseDataHvacMaintenanceReminder.from_dict(
                _hvac_maintenance_reminder
            )

        alert_settings_response_data = cls(
            id=id,
        ...
        alert_settings_response_data.additional_properties = d
        return alert_settings_response_data
