...
from ..models.alert_settings_response_data_hvac_maintenance_reminder_maintenance_interval_units import (
    AlertSettingsResponseDataHvacMaintenanceReminderMaintenanceIntervalUnits,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="AlertSettingsResponseDataHvacMaintenanceReminder")


@attr.s(auto_attribs=True)
class AlertSettingsResponseDataHvacMaintenanceReminder:
    """
    Attributes:
    ...
    maintenance_interval_units: Union[
        Unset, AlertSettingsResponseDataHvacMaintenanceReminderMaintenanceIntervalUnits
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_maintenance_interval_units, Unset):
            ...
            maintenance_interval_units = AlertSettingsResponseDataHvacMaintenanceReminderMaintenanceIntervalUnits(
        ...
        alert_settings_response_data_hvac_maintenance_reminder = cls(
        ...
        alert_settings_response_data_hvac_maintenance_reminder.additional_properties = d
        return alert_settings_response_data_hvac_maintenance_reminder
